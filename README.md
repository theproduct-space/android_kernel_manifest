...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/theproduct-space/android_kernel_manifest/android-15.0/manifest_brcm_rpi.xml --create-dirs
```
